...
function block_viewport() {
		xval=getBusyOverlay('viewport',{color:'blue', opacity:0.1, text:'', style:'text-shadow: 0 0 3px white;font-weight:bold;font-size:18px;color:#666664;'},{color:'#404d9b', size:50, type:'o'});
}
