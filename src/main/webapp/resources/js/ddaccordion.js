...
var ddaccordion={
	...
	jQuery(document).ready(function($){
		...
		if ( expandedindices ==null || (expandedindices.length==1 && expandedindices[0]=="-1")) //check for expandedindices value of [-1], indicating persistence is on and no content expanded
			expandedindices=[]
