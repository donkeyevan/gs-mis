...
<form id="form1" action="<c:url value='/misgroup/add'/>" method="post">
<table class="list">
<tr><td colspan="2"></td></tr>
<tr><td>群组名字:</td><td><input type="text"  name="name" class="input-medium focused fuck" /></td></tr>
<tr><td>群组介绍:</td><td><input type="text" name="comment" class="input-medium focused fuck"></input></td></tr>
